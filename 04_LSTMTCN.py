...
def parse_command_line():
    ...
    parser.add_argument('-n', '--net', type=str, default='LTSMTCN', help='task to be trained')
    parser.add_argument('-f', '--file', type=str, default='LTSMTCN', help='tensorboard location')
    parser.add_argument('-r', '--runs', type=str, default='test/LTSMTCN', help='tensorboard location')
